...
var _v410KubeApiserverDefaultconfigYaml = []byte(`apiVersion: kubecontrolplane.config.openshift.io/v1
...
func v410KubeApiserverDefaultconfigYamlBytes() ([]byte, error) {
	return _v410KubeApiserverDefaultconfigYaml, nil
}

func v410KubeApiserverDefaultconfigYaml() (*asset, error) {
	bytes, err := v410KubeApiserverDefaultconfigYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v4.1.0/kube-apiserver/defaultconfig.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"v4.1.0/kube-apiserver/defaultconfig.yaml":   v410KubeApiserverDefaultconfigYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v4.1.0": {nil, map[string]*bintree{
		"kube-apiserver": {nil, map[string]*bintree{
			...
			"defaultconfig.yaml":   {v410KubeApiserverDefaultconfigYaml, map[string]*bintree{}},
